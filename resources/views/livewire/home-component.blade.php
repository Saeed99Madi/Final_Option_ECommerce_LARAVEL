<main id="main">
    <div class="container">
        ...
        <div class="wrap-show-advance-info-box style-1">
           ...
           {{asset('             <a href="#fashion_1a" cl')}}ass="tab-control-item active">Smartphone</a>
           {{asset('             <a href="#fashion_1b" cl')}}ass="tab-control-item">Watch</a>
           {{asset('             <a href="#fashion_1c" cl')}}ass="tab-control-item">Laptop</a>
           {{asset('             <a href="#fashion_1d" cl')}}ass="tab-control-item">Tablet</a>
                    </div>
                    <div class="tab-contents">
                        ...
                        <div class={{asset('"tab-content-item" id="fashion_1b">
 ')}}                           <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
                        ...
                        <div class={{asset('"tab-content-item" id="fashion_1c">
 ')}}                           <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
                        ...
                        <div class={{asset('"tab-content-item" id="fashion_1d">
 ')}}                           <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
